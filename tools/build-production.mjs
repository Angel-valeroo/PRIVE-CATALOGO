...
await fs.writeFile(path.join(perfumesDir, 'index.html'), `<!doctype html><html lang="es-MX"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Índice de fragancias | Perfumería PRIVÉ</title><meta name="description" content="Índice de fragancias del catálogo de Perfumería PRIVÉ."><link rel="canonical" href="${SITE}/perfumes/"><meta name="robots" content="index,follow"><style>body{font-family:Arial,sans-serif;max-width:900px;margin:40px auto;padding:0 20px;color:#1b1b1b}a{color:#5d4321}li{margin:9px 0}span{color:#666;font-size:.86rem}</style></head><body><h1>Índice de fragancias PRIVÉ</h1><p><a href="${SITE}/">Volver al catálogo interactivo</a></p><ol>${indexItems}</ol></body></html>`, 'utf8');
